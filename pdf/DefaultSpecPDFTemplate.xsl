    ...
    <fo:table table-layout="fixed" font-style="normal" width="100%" border-collapse="collapse">
      ...
      <fo:table-header>
        <fo:table-row line-height="{$s_table_header_height}"  height="{$s_table_header_height}">
          ...
          <fo:table-cell border-width="0.5mm" border-style="solid"><fo:block-container height="9.8mm" reference-orientation="90" inline-progression-dimension="from-parent(line-height)" display-align="center" line-height="4mm"><fo:block text-align="center" font-size="4.0mm">Кол.</fo:block></fo:block-container></fo:table-cell>
	...
	<xsl:param name="pageQty"/>
              ...
              <fo:table table-layout="fixed" width="100%" border-collapse="collapse" font-style="normal" line-height="(40.0mm div 8) - 0.5mm">
                ...
                <fo:table-row height='from-parent(height)'>
                  ...
                  <fo:table-cell border-width="0.5mm" border-style="solid"><fo:block text-align="center"><xsl:value-of select="$Litera"/></fo:block></fo:table-cell>
                  <fo:table-cell border-width="0.5mm" border-style="solid"><fo:block/></fo:table-cell>
                  <fo:table-cell border-width="0.5mm" border-style="solid"><fo:block/></fo:table-cell>
                ...
                <fo:table-row height='from-parent(height)'>
                  <!-- Доп. проверяющий -->
				  <fo:table-cell border-width="0.5mm" border-style="solid" number-columns-spanned="2"><fo:block><xsl:if test="not($AddCheckerPost = ' ')"><xsl:value-of select="$AddCheckerPost"/></xsl:if></fo:block></fo:table-cell>
                  <!-- Spanned cells number-columns-spanned="2" -->
                  ...
                  <!-- Spanned cells number-rows-spanned="5" -->
				  <fo:table-cell border-width="0.5mm" border-style="solid" number-columns-spanned="5" number-rows-spanned="3"><fo:block-container height="14mm" display-align="center"><fo:block text-align="center" font-size="4.5mm"><xsl:value-of select="$Zavod"/>
